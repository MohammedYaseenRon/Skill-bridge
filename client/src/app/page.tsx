  ...
  const features = [
    {
      ...
      description: "Connect with industry professionals and experienced experts"
    },
    {
      icon: Award,
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Connect with industry experts, accelerate your learning, and achieve your career goals 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Why Choose <span className="text-gray-400 bg-clip-text">MentorConnect</span>?
            </h2>
      ...
      <section className="py-20 px-6">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of professionals who have accelerated their growth with expert mentorship
          </p>
          <GradientButton 
            variant="hero" 
            size="xl"
      ...
      <footer className="py-8 px-6 border-t border-border">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-sm text-muted-foreground mt-4">
            © 2024 MentorConnect. Empowering careers through meaningful connections.
          </p>
        </div>
      </footer>
    </PageWrapper>
